...
-- --------------------------------------------------
-- Date Created: 06/05/2014 19:11:00
...
GO
IF OBJECT_ID(N'[dbo].[FK_MA_COUTERPARTYMA_COUTERPARTY]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[MA_COUTERPARTY] DROP CONSTRAINT [FK_MA_COUTERPARTYMA_COUTERPARTY];
GO
IF OBJECT_ID(N'[dbo].[FK_MA_TEMP_CTPY_LIMITMA_CTPY_LIMIT]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[MA_TEMP_CTPY_LIMIT] DROP CONSTRAINT [FK_MA_TEMP_CTPY_LIMITMA_CTPY_LIMIT];
GO
IF OBJECT_ID(N'[dbo].[FK_MA_CTPY_LIMITMA_LIMIT]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[MA_CTPY_LIMIT] DROP CONSTRAINT [FK_MA_CTPY_LIMITMA_LIMIT];
GO
IF OBJECT_ID(N'[dbo].[FK_MA_COUTERPARTYMA_COUNTRY]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[MA_COUTERPARTY] DROP CONSTRAINT [FK_MA_COUTERPARTYMA_COUNTRY];
GO
IF OBJECT_ID(N'[dbo].[FK_MA_COUNTRY_LIMITMA_COUNTRY]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[MA_COUNTRY_LIMIT] DROP CONSTRAINT [FK_MA_COUNTRY_LIMITMA_COUNTRY];
GO
IF OBJECT_ID(N'[dbo].[FK_MA_COUTERPARTYMA_CSA_AGREEMENT]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[MA_CSA_AGREEMENT] DROP CONSTRAINT [FK_MA_COUTERPARTYMA_CSA_AGREEMENT];
GO
IF OBJECT_ID(N'[dbo].[FK_MA_CSA_AGREEMENTMA_CSA_TYPE]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[MA_CSA_AGREEMENT] DROP CONSTRAINT [FK_MA_CSA_AGREEMENTMA_CSA_TYPE];
GO
IF OBJECT_ID(N'[dbo].[FK_MA_CSA_PRODUCTMA_CSA_AGREEMENT]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[MA_CSA_PRODUCT] DROP CONSTRAINT [FK_MA_CSA_PRODUCTMA_CSA_AGREEMENT];
GO
IF OBJECT_ID(N'[dbo].[FK_MA_CSA_PRODUCTMA_PRODUCT]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[MA_CSA_PRODUCT] DROP CONSTRAINT [FK_MA_CSA_PRODUCTMA_PRODUCT];
GO
IF OBJECT_ID(N'[dbo].[FK_DA_TRNDA_TMBA_EXTENSION]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DA_TMBA_EXTENSION] DROP CONSTRAINT [FK_DA_TRNDA_TMBA_EXTENSION];
GO
...
GO
IF OBJECT_ID(N'[dbo].[MA_TEMP_CTPY_LIMIT]', 'U') IS NOT NULL
    DROP TABLE [dbo].[MA_TEMP_CTPY_LIMIT];
GO
IF OBJECT_ID(N'[dbo].[DA_TMBA_EXTENSION]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DA_TMBA_EXTENSION];
GO
IF OBJECT_ID(N'[dbo].[MA_COUNTRY]', 'U') IS NOT NULL
    DROP TABLE [dbo].[MA_COUNTRY];
GO
IF OBJECT_ID(N'[dbo].[MA_COUNTRY_LIMIT]', 'U') IS NOT NULL
    DROP TABLE [dbo].[MA_COUNTRY_LIMIT];
GO
IF OBJECT_ID(N'[dbo].[MA_CSA_TYPE]', 'U') IS NOT NULL
    DROP TABLE [dbo].[MA_CSA_TYPE];
GO
IF OBJECT_ID(N'[dbo].[MA_CSA_AGREEMENT]', 'U') IS NOT NULL
    DROP TABLE [dbo].[MA_CSA_AGREEMENT];
GO
IF OBJECT_ID(N'[dbo].[MA_CSA_PRODUCT]', 'U') IS NOT NULL
    DROP TABLE [dbo].[MA_CSA_PRODUCT];
GO
IF OBJECT_ID(N'[dbo].[MA_TBMA_CONFIG]', 'U') IS NOT NULL
    DROP TABLE [dbo].[MA_TBMA_CONFIG];
GO
...
CREATE TABLE [dbo].[DA_TRN] (
    ...
    [FIRST_FIRSTFIXINGAMT] decimal(20,8)  NULL,
    [FIRST_FREQTYPE_ID] uniqueidentifier  NULL,
    [FIRST_RATE] decimal(20,8)  NULL,
    [FIRST_SWAP_POINT] decimal(20,8)  NULL,
    ...
    [SECOND_FIRSTFIXINGAMT] decimal(20,8)  NULL,
    [SECOND_FREQTYPE_ID] uniqueidentifier  NULL,
    [SECOND_RATE] decimal(20,8)  NULL,
    [SECOND_SWAP_POINT] decimal(20,8)  NULL,
    ...
    [FLAG_PCE] bit  NULL,
    [OVER_COUNTRY_AMOUNT] decimal(18,4)  NULL
);
GO
...
CREATE TABLE [dbo].[MA_COUTERPARTY] (
    ...
    [LOG_MODIFYBYUSERID] uniqueidentifier  NULL,
    [LOG_MODIFYDATE] datetime  NULL,
    [GROUP_CTPY_ID] uniqueidentifier  NULL,
    [TBMA_NAME] nvarchar(10)  NULL,
...
CREATE TABLE [dbo].[MA_PCCF] (
    ...
    [C21] decimal(18,2)  NULL,
    [C22] decimal(18,2)  NULL,
    [C23] decimal(18,2)  NULL,
    [C24] decimal(18,2)  NULL
);
GO
...
CREATE TABLE [dbo].[DA_TRN_MATCH] (
    ...
    [EXT_TRN_ID] nvarchar(50)  NOT NULL,
    [STATUS_ID] uniqueidentifier  NOT NULL,
    [LOG_INSERTBYUSERID] uniqueidentifier  NOT NULL,
    [LOG_INSERTDATE] datetime  NOT NULL,
    [LOG_MODIFYBYUSERID] uniqueidentifier  NULL,
...
CREATE TABLE [dbo].[MA_CSA_AGREEMENT] (
    [ID] uniqueidentifier  NOT NULL,
    [CSA_TYPE_ID] uniqueidentifier  NULL,
    [LOG_INSERTBYUSERID] uniqueidentifier  NOT NULL,
    [LOG_INSERTDATE] datetime  NOT NULL,
    [LOG_MODIFYBYUSERID] uniqueidentifier  NULL,
    [LOG_MODIFYDATE] datetime  NULL,
...
ALTER TABLE [dbo].[MA_CTPY_LIMIT]
ADD CONSTRAINT [FK_MA_CTPY_LIMITMA_LIMIT]
    FOREIGN KEY ([LIMIT_ID])
    REFERENCES [dbo].[MA_LIMIT]
        ([ID])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_MA_CTPY_LIMITMA_LIMIT'
CREATE INDEX [IX_FK_MA_CTPY_LIMITMA_LIMIT]
ON [dbo].[MA_CTPY_LIMIT]
    ([LIMIT_ID]);
GO
...
-- Creating foreign key on [CSA_AGREEMENT_ID] in table 'MA_CSA_PRODUCT'
ALTER TABLE [dbo].[MA_CSA_PRODUCT]
...
-- Creating foreign key on [PRODUCT_ID] in table 'MA_CSA_PRODUCT'
ALTER TABLE [dbo].[MA_CSA_PRODUCT]
