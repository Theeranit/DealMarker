...
{
    public partial class FXSpotEntryInfo : BasePage
    {  
        ...
        [WebMethod(EnableSession = true)]
        public static object GenerateTrnObject(string strTradeDate, string strSpotDate, string strCtpy, string strPortfolio
                                                , string strCurrencyPair, string strBS, string strContractCcy,string strCounterCcy
                                                , string strSpotRate, string strContractAmt, string strCounterAmt, string strRemark, string strProductId, bool settleFlag, bool blnIsSubmit)
        {
            try
            {
                DA_TRN TrnInfo = DealUIP.GenerateFXSpotTransactionObject(SessionInfo, strTradeDate, strSpotDate, strCtpy, strPortfolio
        ...
        public static object GetEditByID(Guid id)
        {
            try {
                ...
                var query = new { ID = trn.ID,
                            TradeDate = trn.TRADE_DATE.Value.ToString(FormatTemplate.DATE_DMY_LABEL),
                            MaturityDate = trn.MATURITY_DATE.Value.ToString(FormatTemplate.DATE_DMY_LABEL),
        ...
        {
            return InstrumentUIP.GetInstrumentByName(SessionInfo, ProductCode.FXSPOT, name_startsWith.ToUpper());
        }
    }
}