<%@ Page Title="" Language="C#" MasterPageFile="~/Dialog.Master" AutoEventWireup="true" CodeBehind="FXForwardEntryInfo.aspx.cs" Inherits="KK.DealMaker.Web.Deal.FXForwardEntryInfo" %>
        ...
        <div class="table-container">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="setdate" id="setdate" class="round input-form-textbox"/>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <input type="text" id="swappoint" name="swappoint" class="round input-form-number"/>
                    </td>
                </tr>
                <tr>
                    <td>
         ...
         <script type="text/javascript">
             ...
             $(document).ready(function () {
                 productid = '<%= ProductId %>';
                 $('#title').text('FX Forward Deal Entry');
                 $('#setdate').datepicker({ dateFormat: "dd/mm/yy", changeYear: true }).datepicker("setDate", '<%= GetSpotDateString() %>');
                 ...
                 $('#swappoint').autoNumeric('init', { vMin: '-9999999.99999999', vMax: '9999999.99999999' })
                 .change(function () {
                     CalCounterAmt();
                 });
                 $('#contractamt').change(function () {
                     CalCounterAmt();
                 })
                 .autoNumeric('init');
                 $('#ccy').change(function () {
                     ...
                     $.ajax({
                         ...
                         success: function (msg) {
                             if (msg.d.Result == 'OK') {
                                 ...
                                 $('#setdate').val(msg.d.record.MaturityDate);
                                 $('#buysell').val(msg.d.record.BuySell);
                                 $('#spotrate').autoNumeric('set', msg.d.record.SpotRate);
                                 $('#swappoint').autoNumeric('set', msg.d.record.SwapPoint);
             ...
             function GetInstrument() {
                 ...
                 $.ajax({
                     type: "POST",
                     url: '<%= Page.ResolveClientUrl("FXForwardEntryInfo.aspx/GetInstrument") %>',
                     data: predate,
                     contentType: "application/json; charset=utf-8",
                     dataType: "json",
                     success: function (msg) {
             ...
             function CalCounterAmt() {
                 ...
                 var swappoint = parseFloat($('#swappoint').autoNumeric('get'));
                 ...
                 if (ccyType == '1' && flag_mul) {
                     counteramt.autoNumeric('set',contractamtval * (spotrate + swappoint));
                 }
             ...
             function CalContractAmt() {
                 ...
                 var flag_mul = $('#ccy').data('flag');
                 if (ccyType == '1' && flag_mul) {
                     contractamt.autoNumeric('set', counteramtval / (spotrate + swappoint));
                 }
                 else if (ccyType == '2' && flag_mul) {
                     contractamt.autoNumeric('set', counteramtval * (spotrate + swappoint));
                 }
             ...
             function GenerateObjects(blnIsSubmit) {
                 var pData = "{ "
                        ...
                        + ", strSwapPoint : '" + $('#swappoint').autoNumeric('get') + "'"
                 ...
                 $.ajax({
                     type: "POST",
                     url: '<%= Page.ResolveClientUrl("FXForwardEntryInfo.aspx/GenerateTrnObject") %>',
                     data: pData,
                     contentType: "application/json; charset=utf-8",
                     dataType: "json",
                     success: function (msg) {
             ...
             function submit_deal(strOverApprover, strOverComment) {
                 ...
                 $.ajax({
                     type: "POST",
                     url: '<%= Page.ResolveClientUrl("FXForwardEntryInfo.aspx/SubmitDeal") %>',
                     data: pData,
                     contentType: "application/json; charset=utf-8",
                     dataType: "json",
                     success: function (msg) {
             ...
             function ValidateForm() {
                 ...
                 mess = $("#setdate").val() == '' && mess == '' ? 'Please input settlement date.' : mess;
                 mess = isValidDate($("#spotdate").val()) == false && mess == '' ? 'Invalid spot date.' : mess;
                 mess = isValidDate($("#setdate").val()) == false && mess == '' ? 'Invalid settlement date.' : mess;
                 mess = StrToDate($("#tradedate").val()) >= StrToDate($("#setdate").val()) && mess == '' ? 'Settlement date must be after trade date.' : mess;
                 mess = StrToDate($("#tradedate").val()) >= StrToDate($("#spotdate").val()) && mess == '' ? 'Spot date must be after trade date.' : mess;
                 mess = $("#setdate").val() == $("#spotdate").val() && mess == '' ? 'Settlement date must not equal to spot date.' : mess;
                 ...
                 mess = $("#swappoint").autoNumeric('get') == '' && mess == '' ? 'Please input Swap point.' : mess;
             ...
             function SetDropdown(counterpartyVal, portfolioVal, currencypairVal) {
                 ...
                 set_options('currencypair', null, 'GetFXForwardInstrumentOptions', function() {
